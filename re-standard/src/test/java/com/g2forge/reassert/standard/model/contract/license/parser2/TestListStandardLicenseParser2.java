...
import com.g2forge.reassert.standard.model.contract.license.parser.TestListStandardLicenseParser;
...
public class TestListStandardLicenseParser2 {
	@Data
	...
	private final IParser<ILicenseApplied> parser = StandardLicenseParser2.create();
	...
	public void test() {
		...
		final String purpose = getPurpose();
		if (purpose != null) HAssert.assertEquals(purpose, getLicense(), actual);
		else HAssert.assertNotEquals(getLicense(), actual);
	}
}
