...
public class TestAnalyzeTermExpressionEvaluator {
	@Test
	public void test() {
		final IExpression<IContractComparisonName, TermRelation> expression = IContractComparisonRules.rule(b -> b.expression(or(b.notB(TestUsageTerm.Term), b.a(TestLicenseTerm.Permission)))).getExpression();
