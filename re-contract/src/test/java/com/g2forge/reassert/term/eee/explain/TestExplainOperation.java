...
public class TestExplainOperation extends ATestExplanationRenderer {
	...
	public void identity() {
		...
		HAssert.assertEquals("2 (*) - because there's a single relevant argument: 1", render(ExplanationMode.Describe, new IdentityExplainedOperation<Integer>(2, "*", 1).toBuilder().argument$(false, new Literal<>(1)).argument$(true, new Literal<>("Non-identity", 2)).build()));
	}
