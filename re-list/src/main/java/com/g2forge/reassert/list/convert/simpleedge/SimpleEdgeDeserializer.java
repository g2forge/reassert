...
public class SimpleEdgeDeserializer extends StdDeserializer<IEdge> implements ResolvableDeserializer {
	...
	protected static final Map<String, ISupplier<? extends IEdge>> suppliers = HCollection.<Class<? extends IEdge>>asList(Contains.class, Coordinates.class, Copy.class, Describes.class, Inherits.class, Notice.class, Parsed.class).stream().collect(Collectors.toMap(c -> c.getSimpleName().toLowerCase(), c -> {
